...
activities = {
    ...
    ,
    "Soccer Team": {
        "description": "Competitive soccer team practicing strategies and teamwork",
    ...
    "Science Olympiad": {
        "description": "Team-based science and engineering competitions",
        "schedule": "Wednesdays, 3:30 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["elijah@mergington.edu", "lucas@mergington.edu"]
    },
    "Debate Team": {
        "description": "Prepare for and compete in speech and debate tournaments",
